 ...
 */
public class VitalityServerConstant {
    ...
    public static final String VITALITY_SERVER_QUARTZ = "VITALITY-Server-Quartz";
    public static final String VITALITY_SERVER_CONFIG = "VITALITY-Server-Config";
}
